        ...
        <header data-bs-theme="dark">
            <div className="collapse text-bg-dark" id="navbarHeader">
                ...
                <div className="row">
                    ...
                    <p className="text-body-secondary">Hi, the articles I share here are related to web development and coding in general. Feel free to read and comment if you like - just be nice.</p>
                    </div>
                    <div className="col-sm-4 offset-md-1 py-4">
                    <h4 className='contact'>Contact</h4>
                    <ul className="list-unstyled">

                        <li><Link to="https://www.instagram.com/ant0nio.herrera/" className="text-white" target='new' data-toggle='tooltip' data-placement='right' title='Instagram'><FaInstagram size={25}/></Link></li>
